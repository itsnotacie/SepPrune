...
from look2hear.models.sudormrf_pruned import ConvNormAct_pruned, ChannelMask1D
...
parser.add_argument(
    "--conf_dir",
    default="configs/mask_sudormrf.yaml",
...
# ##### 随机初始化，从scrach训练
    ...
    # print(model)
#  ##### 加载预训练权重 retrain
    if config["exp"]["exp_name"] == 'MASKSuDORMRF':
        model_path = '/public/ly/other/Look2hear/look2hear/exp/tdanet/sudormrf_LRS2.pth'
    elif config["exp"]["exp_name"] == 'MASKSuDORMRF_EchoSet':
        print('using MASKSuDORMRF_EchoSet')
        model_path = '/public/ly/other/Look2hear/experiments/checkpoint/SuDORMRF_EchoSet_ori/epoch=319.ckpt'
    elif config["exp"]["exp_name"] == 'MASKSuDORMRF_LibriMix':
        print('using MASKSuDORMRF_LibriMix')
