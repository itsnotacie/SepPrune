...
##### 随机初始化，从scrach训练
 ...
 ###### 加载预训练权重 retrain
    # model_path = '/public/ly/other/Look2hear/look2hear/exp/tdanet/best_model.pth'
 ...
 #### 训练时锁死mask 权重或者锁死其他部分权重
    # for name, param in model.named_parameters():
    #     # if 'sm.unet.globalatt.mlp.fc1.mask' in name or 'sm.unet.globalatt.mlp.fc2.mask' in name:
    #     #     param.requires_grad = False
    #     if name in ['sm.unet.globalatt.mlp.fc1.mask','sm.unet.globalatt.mlp.fc2.mask']:
    #         param.requires_grad = False
    #         print(name)
