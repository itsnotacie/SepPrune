...
def main(config):
    ...
    progress = Progress(
     ...
     ### 加载预训练权重
    # model_path = '/data/stan_2024/24_2024_spearate/Look2hear/Experiments/checkpoint/AFRCNN_16/best_model.pth'
    ### 加载retrain后的权重
    model_path = '/public/ly/other/Look2hear/look2hear/exp/tdanet/afrcnn16_LRS2_bak_best_model.pth'
